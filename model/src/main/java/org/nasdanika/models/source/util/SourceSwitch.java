 ...
 * @generated
 */
public class SourceSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SourcePackage.TOKEN_SOURCE: {
				@SuppressWarnings("unchecked") Function<String, String> tokenSource = (Function<String, String>)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Token Source</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Token Source</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseTokenSource(Function<String, String> object) {
		return null;
	}
